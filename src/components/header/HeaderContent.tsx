...
const HeaderContent: FC<HeaderContentProps> = () => {
  ...
  return (
    <div className='flex h-full absolute  inset-25 sm:inset-40  flex-col  items-center justify-center transition-all duration-300 ease-in-out'>
      ...
      <motion.p
        className='w-[35rem] text-sm sm:text-base text-center my-3 max-w-full text-gray-200 font-medium drop-shadow-md'
        variants={fadeInUp}
        initial='hidden'
        whileInView='visible'
      ...
      >
        <a
          href='#contact'
          className='btn text-xs sm:text-base text-white font-bold shadow-lg hover:scale-103 hover:from-blue-500 hover:to-pink-500 transition-all duration-200'
        >
          Let&#39;s Talk
        </a>
        <a href='#myWork' className='btn text-xs sm:text-base bg-gray-200 text-black'>
          My Work
        </a>
      </motion.div>
    </div>
